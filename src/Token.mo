...
shared ({ caller = _owner }) actor class Token(
  ...
  public shared query func icrc1_metadata() : async [ICRC1.MetaDatum] {
    ...
    return [
      ("icrc1:name", #Text("PAI DAO")),
      ("icrc1:symbol", #Text("PAIDA")),
      ("icrc1:decimals", #Nat(8)),
      ("icrc1:fee", #Nat(1)), // Representing the fee as a natural number
      (
        "icrc1:logo",
        #Text(
  ...
  public shared query func icrc2_metadata() : async [ICRC1.MetaDatum] {
    icrc2().metadata();
  };
  ...
  chwnl-joc6j-6gwri-upw7o-azgks-nhjcs-tkuqg-w4w2y-7k22p-fhnu2-yqe

  dfx canister --network ic call vyttn-eiaaa-aaaan-qzn5a-cai icrc2_allowance '(
  record {
    account = record {
      owner = principal "g2hfb-asnnj-44kxu-6z7oh-dw2hy-a5iae-vw5yw-7gt5b-i5akq-zxbwd-jqe";
      subaccount = null;
    };
    spender = record {
      owner = principal "6izmc-hwsvw-swlvp-wi43f-parus-dzjvu-umax3-ugmuw-kkzb4-qpbwj-dae";
      subaccount = null;
    };
  }
)'

dfx canister --network ic call vyttn-eiaaa-aaaan-qzn5a-cai icrc2_approve '(
  record {
    account = record {
      owner = principal "chwnl-joc6j-6gwri-upw7o-azgks-nhjcs-tkuqg-w4w2y-7k22p-fhnu2-yqe";
      subaccount = null;
    };
    spender = record {
      owner = principal "6izmc-hwsvw-swlvp-wi43f-parus-dzjvu-umax3-ugmuw-kkzb4-qpbwj-dae";
    ...
    amount = 100; // 10 tokens in smallest units
    expires_at = null;
  }
)'
